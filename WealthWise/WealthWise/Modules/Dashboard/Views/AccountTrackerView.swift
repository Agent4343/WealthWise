        ...
        ScrollView {
            VStack(spacing: 20) {
                ...
                accountDetailCard(
                    ...
                    explanation: "Your TFSA room accumulates each year ($7,000 for 2026). Cumulative room since 2009 is $109,000. Withdrawals restore room on January 1st of the following year."
                )
